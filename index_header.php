...
<body>
  <header>
    <div class="logo">
        <a href="index.php"><span>Vidya Store 📖</span>
    </div>
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/alok/bookflix/index.php#New">New Arrived</a>
                <a href="http://localhost/alok/bookflix/index.php#Adventure">Adventure</a>
                <a href="http://localhost/alok/bookflix/index.php#Magical">Magic</a>
                <a href="http://localhost/alok/bookflix/index.php#Knowledge">Knowledge</a>

        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="fname" name="firstname" placeholder="Ankit Kumar">
              <label for="email"><i class="fa fa-envelope"></i> Email</label>
              <input type="text" id="email" name="email" placeholder="example@gmail.com">
              <label for="email"><i class="fa fa-envelope"></i> Number</label>
              <input type="text" id="email" name="number" placeholder="+918102334400">
              <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
              <input type="text" id="adr" name="address" placeholder="Rajkot 10">
              <label for="city"><i class="fa fa-institution"></i> City</label>
              <input type="text" id="city" name="city" placeholder="Rajkot">
              <label for="city"><i class="fa fa-institution"></i> State</label>
              <input type="text" id="city" name="state" placeholder="Gujarat">
              ...
              <div style="padding: 0px;" class="row">
                ...
                <div class="col-50">
                  ...
                  <input type="text" id="zip" name="pincode" placeholder="360020">
                </div>
              </div>
            </div>

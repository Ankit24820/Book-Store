        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                ...
                <ul>
                    ...
                    <li>+918102334400</li>
                    <li>+919128415272</li>
                    <li>akumar870@rku.ac.in</li>
                    <li>akumar470@rku.ac.in</li>
                    <li>akumar028@rku.ac.in</li>
                    <li>Address: Rajkot 360020</li>
                </ul>

            </div>
        </div>
        <div style=" align-items:center; justify-content:center; margin:20px 0 0 ;" class="cmsg flex">
            <p>Designed By Aditya Kumar , Alok kumar , Ankit Kumar | Copyright &copy; <script>
                    document.write(new Date().getFullYear())
                </script> All Rights are reserved by &nbsp</p>
            <div style="font-size: 30px;" class="logo">
                <a href="index.php"><span style="font-size: 15px;"> Vidya Store 📖 </span>

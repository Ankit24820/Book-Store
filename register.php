...
$(document).ready(function(){
    $('#registerForm').submit(function(event){
        ...
        var surname = $('input[name="Sname"]').val();
        ...
        if(name === ''){
            $('input[name="Name"]').after('<span class="error">Please enter your name</span>');
        }
        if(surname === ''){
            $('input[name="Sname"]').after('<span class="error">Please enter your surname</span>');
        }
        if(email === ''){
            $('input[name="email"]').after('<span class="error">Please enter your email</span>');
        } else if(!isValidEmail(email)){
            $('input[name="email"]').after('<span class="error">Please enter a valid email</span>');
        }
        if(password === ''){
            $('input[name="password"]').after('<span class="error">Please enter your password</span>');
        }
        if(cpassword === ''){
            $('input[name="cpassword"]').after('<span class="error">Please confirm your password</span>');
        } else if(password !== cpassword){
            $('input[name="cpassword"]').after('<span class="error">Passwords do not match</span>');
        }
